...
const char* gatewayIP  = "192.168.137.169";  // ⚠️ SESUAIKAN DENGAN IP GATEWAY!
...
const unsigned long DUR_LONG       = 120000;
...
void setPump(bool state) {
  ...
  digitalWrite(PUMP_NUTRISI_A_PIN, level);
  digitalWrite(PUMP_NUTRISI_B_PIN, level);
}
